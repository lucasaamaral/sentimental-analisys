...
SECONDARY_MODEL_HF_REPO = "lucasalmda/pt-br-financial-sentimental-analysis-secondary"
FINETUNED_MODEL_DIR = MODELS_DIR / "finbert-pt-br-finetuned"
SECONDARY_MODEL_DIR = MODELS_DIR / "finbert-pt-br-finetuned-secondary"
...
CALIBRATION_SPLIT_PATH = (
    OUTPUT_DIR / "samples_calibration.csv"
)  # Temporary, created and deleted during training
